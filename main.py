...
conversation = [
    {
        "role": "system",
        "content": "You are a chat bot designed only to answer questions about Coding. You do not know anything else. If someone asks questions on topics apart from Coding, just say you don't know."
    }
]
...
input_box = st.text_input("Enter your query about Coding:")
